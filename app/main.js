...
ipcMain.handle('save-settings', async (event, settings) => ({ ok: true, settings: writeSettings(settings) }));

ipcMain.handle('load-settings', async () => ({ ok: true, settings: readSettings() }));
